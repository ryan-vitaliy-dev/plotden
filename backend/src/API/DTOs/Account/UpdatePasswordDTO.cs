...
namespace API.DTOs.Account
{
    public class UpdatePasswordDTO
    {
        ...
        [MaxLength(100, ErrorMessageResourceName = "Account_UpdatePassword_Error_InvalidCurrent", ErrorMessageResourceType = typeof(Application.Resources.SharedResource))]
        public string CurrentPassword { get; set; } = null!;

        [JsonPropertyName("new")]
        [Required(ErrorMessageResourceName = "Account_UpdatePassword_Error_MissingNew", ErrorMessageResourceType = typeof(Application.Resources.SharedResource))]
        [RegularExpression(
