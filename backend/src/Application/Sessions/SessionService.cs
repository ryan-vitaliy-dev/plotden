...
namespace backend.Application.Sessions
{
    public class SessionService(AppDbContext context)
    {
        ...
        */
        ...
        /// </returns>
        public async Task<ServiceResult<Session>> CreateSessionAsync(Guid accountId, string ipAddress, string userAgent = "Unknown", DateTime? createdAtOverride = null, CancellationToken clt = default)
        {
            ...
            try
            {
                ...
                DateTime expiresAt = createdAt.AddDays(7); // TODO: make session expiration configurable
